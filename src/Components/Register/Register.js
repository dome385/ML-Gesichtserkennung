...
class Register extends React.Component  {
    ...
    <div>
        ...
        <legend className="f2 fw6 ph0 mh0">Registrieren</legend>
        <div class="mt3">
        ...
        <div className="">
        <input onClick={this.onSubmitSignIn} className="b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib" type="submit" value="Registrieren"/>
        </div>
    </div>
</main>
</article>
